...
- `../docs`: provider contract and design documentation.
- `../logs`: implementation logs.
- `../plans`: implementation plans.

## CI

GitHub Actions runs install, typecheck, tests, production build, and production dependency audit from the `frontend/` working directory.
