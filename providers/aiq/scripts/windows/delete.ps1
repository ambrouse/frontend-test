...
$Port = $env:AIHUB_PORT; if (-not $Port) { $Port = "6917" }
...
Write-ProviderStatus -ProviderId $Id -Root $Root -State "not_installed" -Port ([int]$Port) -Step "Deleted AI-Q deploy and local Docker resources" -ExtraHealth @{ backendPort = 6918 }
